    ...
    private static var _reelConfig:Object =
            {
                reel1: {
                    ...
                    stop: ["BAR3", "CHERRY", "WILD", "BAR3", "BLANK", "BONUS", "BLANK", "BAR2", "BLANK", "H7", "BLANK", "BAR1", "BLANK", "WILD", "BLANK", "BAR3", "BLANK", "BONUS", "BLANK", "H7", "BLANK", "CHERRY"]
                },
                reel2: {
                    weight: [2, 25, 10, 15, 30, 15, 30, 20, 8, 10, 8, 40, 2, 3, 2, 20, 30, 20, 30, 10, 2, 2],
                    stop: ["BLANK", "WILD", "CHERRY", "BAR3", "BLANK", "BONUS", "BLANK", "BAR1", "BLANK", "H7", "BLANK", "BAR2", "BLANK", "WILD", "BLANK", "BAR1", "BLANK", "BONUS", "BLANK", "H7", "BLANK", "CHERRY"]
                },
                reel3: {
                    weight: [3, 25, 10, 25, 15, 20, 15, 40, 8, 10, 8, 25, 1, 2, 1, 15, 15, 20, 15, 10, 3, 3],
                    stop: ["H7", "BONUS", "BAR1", "BAR3", "BLANK", "BONUS", "BLANK", "BAR2", "BLANK", "H7", "BLANK", "BAR1", "BLANK", "WILD", "BLANK", "BAR2", "BLANK", "BONUS", "BLANK", "H7", "BLANK", "CHERRY"]
                }
            };
